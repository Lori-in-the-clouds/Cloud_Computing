...
for row in range(data.shape[0]):
    ...
    list_ic_costo.append([n,ic])   

#Per salvare i valoir di N, IC e costo in un file    
np.savetxt("results/ic_mu1_err.data", list_ic_costo, header="N\tIC", fmt=['%d', '%.8f'])
...
#Per salvare i valoir di N, IC e costo in un file    
np.savetxt("results/ic_mu2_err.data", list_ic_costo, header="N\tIC", fmt=['%d', '%.8f'])