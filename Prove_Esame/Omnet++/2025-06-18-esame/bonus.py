...
data_mu1 = np.loadtxt("results/fase_2_mu1.data") 
data_mu2 = np.loadtxt("results/fase_2_mu2.data") 
...
#Per ricavare il CI
data_ci_mu1 = np.loadtxt("results/ic_mu1_err.data") 
data_ci_mu2 = np.loadtxt("results/ic_mu2_err.data")
...
if __name__ == "__main__":
    ...
    range_N_1 =list(range(25, 51)) 
    range_N_2 =list(range(15, 51))
    mu_1 = 10
    mu_2 = 15
